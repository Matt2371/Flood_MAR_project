...
def dac_compare_strategies(layer):
    ...
    plt.title('Average annual GW: ' + layer + ' layer under DACs')
...
def dac_boxplot(strategy, layer):
    ...
    plt.title('GW level under DACs: ' + strategy.lower() + ' strategy ' + layer.lower() + ' layer')
    plt.ylabel('Groundwater level, ft')
    plt.xlabel('Year')
...
def dac_boxplot_del(strategy, layer):
    ...
    # create boxplot
    df.T.plot.box(showfliers=False)
    plt.title('GW deltas under DACs: ' + strategy.lower() + ' strategy ' + layer.lower() + ' layer')
    plt.ylabel('Groundwater level, ft')
    plt.xlabel('Year')
